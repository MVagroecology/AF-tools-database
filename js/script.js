  ...
  created() {
    ...
    getToolsData() {
      var myself = this
			...
			$.getJSON('https://cdn.jsdelivr.net/gh/euraf/AF-tools-database@latest/tools/tools_list.json', function (data) {
				for (var i = 0; i < data.length; i++) {
						$.getJSON('https://cdn.jsdelivr.net/gh/euraf/AF-tools-database@latest/tools/' + data[i] + '.json', function (tool) {
      ...
      var myself = this
			...
			$.getJSON('https://cdn.jsdelivr.net/gh/euraf/AF-tools-database@latest/tools/tools_form.json', function (form) {
				myself.form = form
			})
		},
	}
